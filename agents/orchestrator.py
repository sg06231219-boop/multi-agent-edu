...
class Orchestrator:
    ...
    async def run_full_pipeline(self, profile: dict) -> dict:
        ...
        pipeline_result["final_output"] = {"diagnosis": diagnosis, "knowledge": knowledge, "review": review_result, "practice": practice, "quiz": quiz}
    ...
    async def run_streaming(self, profile: dict) -> AsyncGenerator[dict, None]:
        ...
        try:
            ...
            yield {"type": "pipeline_done", "result": {"diagnosis": diagnosis, "knowledge": knowledge, "review": review, "practice": practice, "quiz": quiz}}
